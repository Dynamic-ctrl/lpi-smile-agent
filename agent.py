...
def audit_architecture(raw_concept: str):
    ...
    3. NO BULLET POINTS.
    4. MANDATORY CITATION: You MUST begin every single critique with exactly one of these tool citations: [SOURCE: LPI/smile_overview], [SOURCE: LPI/query_knowledge], [SOURCE: LPI/get_case_studies], [SOURCE: LPI/smile_phase_detail].

    CONTEXT DATA:
    [SOURCE: LPI/smile_overview]: {context_data.get('overview')}
    [SOURCE: LPI/query_knowledge]: {context_data.get('knowledge')}
    [SOURCE: LPI/get_case_studies]: {context_data.get('cases')}
    [SOURCE: LPI/smile_phase_detail]: {context_data.get('phase')}
    ...
    print("[1] Tool: smile_overview     -> Sourced baseline architectural safety hazards.")
    print("[2] Tool: query_knowledge    -> Sourced specific manual override constraints.")
    print("[3] Tool: get_case_studies   -> Sourced past failure metrics.")
    print("[4] Tool: smile_phase_detail -> Sourced sensor implementation gaps.")
    print("="*50 + "\n")
